...
SHARED_RULES = (
    ...
    "4. NO TRAILING ELLIPSES: Do NOT end any field with '...', '..', or a dangling clause. "
    "Every summary must end with a complete sentence and a single period.\n"
...
def newsletter_composer_prompt(
    ...
    return (
        ...
        "    * 'pointer'         : 1 short factual sentence — the headline. Max ~25 words.\n"
        ...
        "- For EACH competitor item, produce TWO distinct text fields:\n"
        "    * 'event'     = a SHORT factual headline (1 sentence, ~20 words max). What happened.\n"
        "    * 'narrative' = a LONGER elaboration (2-3 sentences) that ADDS NEW INFORMATION beyond\n"
        "                    'event' — strategic implication, expected market read-through, how\n"
        "                    this changes the competitor's position, sector context. The narrative\n"
        "                    MUST NOT paraphrase or repeat the event sentence. If you cannot\n"
        "                    write a substantively different narrative, leave the field empty.\n"
        "    * Bad example:\n"
